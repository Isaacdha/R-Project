...
# Tentative Model List & Check
manual_arima <- function(data, p, d, q, s = NULL, P = NULL, D = NULL, Q = NULL, xreg = NULL) {
...
#Intervention Helper
generate_intervention <- function(ts_data, intervention_point, types = c("step", "ramp", "pulse"), 
                                  pulse_start = NULL, pulse_end = NULL, mode = c("regular", "forecast"), 
